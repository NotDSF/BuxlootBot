...
import { issues } from "../bot_issues.json"
...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName("bot-help")
        .setDescription("Do you need help with the BuxLoot bot? This command will answer all your questions")
